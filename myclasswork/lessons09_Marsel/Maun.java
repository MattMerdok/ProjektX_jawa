...
public class Maun {
    public static void main(String[] args) {
        ...
        // TODO: для тестирования положили данные в программу
        int count5 = 4;
        int count10 = 10;
        int count20 = 23;
        int count50 = 54;
        ...
        // TODO: для тестирования сразу считаем баланс пользователя, потому что есть тестовые данные, потом убрать
